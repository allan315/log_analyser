...
# Top articles query (needs to have "view_count" view).
# It connects articles and logs using modified path in log table which is
# connected to slug to get view count.
...
# Top authors query (needs to have "view_count" view).
# This query can be divided to two steps 1. we connect view_count
# with articles, 2. we connect this result with authors table to get
...
# Log errors query (needs to have "ok" and "errors" view).
